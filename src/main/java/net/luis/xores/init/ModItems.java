...
public class ModItems {
	...
	public static final RegistryObject<ShieldItem> COPPER_SHIELD = ITEMS.register("copper_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/copper_shield.png"));
	});
	public static final RegistryObject<ShieldItem> GOLDEN_SHIELD = ITEMS.register("golden_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/golden_shield.png"));
	});
	public static final RegistryObject<ShieldItem> IRON_SHIELD = ITEMS.register("iron_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/iron_shield.png"));
	});
	public static final RegistryObject<ShieldItem> DIAMOND_SHIELD = ITEMS.register("diamond_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/diamond_shield.png"));
	});
	public static final RegistryObject<ShieldItem> NETHERITE_SHIELD = ITEMS.register("netherite_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/netherite_shield.png"));
	});
	...
	public static final RegistryObject<SwordItem> JADE_SWORD = ITEMS.register("jade_sword", () -> {
		return new SwordItem(ModTiers.JADE, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> JADE_PICKAXE = ITEMS.register("jade_pickaxe", () -> {
		return new PickaxeItem(ModTiers.JADE, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> JADE_AXE = ITEMS.register("jade_axe", () -> {
		return new AxeItem(ModTiers.JADE, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> JADE_SHOVEL = ITEMS.register("jade_shovel", () -> {
		return new ShovelItem(ModTiers.JADE, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> JADE_HOE = ITEMS.register("jade_hoe", () -> {
		return new HoeItem(ModTiers.JADE, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> LIMONITE_SWORD = ITEMS.register("limonite_sword", () -> {
		return new SwordItem(ModTiers.LIMONITE, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> LIMONITE_PICKAXE = ITEMS.register("limonite_pickaxe", () -> {
		return new PickaxeItem(ModTiers.LIMONITE, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> LIMONITE_AXE = ITEMS.register("limonite_axe", () -> {
		return new AxeItem(ModTiers.LIMONITE, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> LIMONITE_SHOVEL = ITEMS.register("limonite_shovel", () -> {
		return new ShovelItem(ModTiers.LIMONITE, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> LIMONITE_HOE = ITEMS.register("limonite_hoe", () -> {
		return new HoeItem(ModTiers.LIMONITE, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> BLAZING_SWORD = ITEMS.register("blazing_sword", () -> {
		return new SwordItem(ModTiers.BLAZING, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> BLAZING_PICKAXE = ITEMS.register("blazing_pickaxe", () -> {
		return new PickaxeItem(ModTiers.BLAZING, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> BLAZING_AXE = ITEMS.register("blazing_axe", () -> {
		return new AxeItem(ModTiers.BLAZING, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> BLAZING_SHOVEL = ITEMS.register("blazing_shovel", () -> {
		return new ShovelItem(ModTiers.BLAZING, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> BLAZING_HOE = ITEMS.register("blazing_hoe", () -> {
		return new HoeItem(ModTiers.BLAZING, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> ROSITE_SWORD = ITEMS.register("rosite_sword", () -> {
		return new SwordItem(ModTiers.ROSITE, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> ROSITE_PICKAXE = ITEMS.register("rosite_pickaxe", () -> {
		return new PickaxeItem(ModTiers.ROSITE, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> ROSITE_AXE = ITEMS.register("rosite_axe", () -> {
		return new AxeItem(ModTiers.ROSITE, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> ROSITE_SHOVEL = ITEMS.register("rosite_shovel", () -> {
		return new ShovelItem(ModTiers.ROSITE, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> ROSITE_HOE = ITEMS.register("rosite_hoe", () -> {
		return new HoeItem(ModTiers.ROSITE, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> ROSE_QUARTZ_SWORD = ITEMS.register("rose_quartz_sword", () -> {
		return new SwordItem(ModTiers.ROSE_QUARTZ, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> ROSE_QUARTZ_PICKAXE = ITEMS.register("rose_quartz_pickaxe", () -> {
		return new PickaxeItem(ModTiers.ROSE_QUARTZ, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> ROSE_QUARTZ_AXE = ITEMS.register("rose_quartz_axe", () -> {
		return new AxeItem(ModTiers.ROSE_QUARTZ, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> ROSE_QUARTZ_SHOVEL = ITEMS.register("rose_quartz_shovel", () -> {
		return new ShovelItem(ModTiers.ROSE_QUARTZ, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> ROSE_QUARTZ_HOE = ITEMS.register("rose_quartz_hoe", () -> {
		return new HoeItem(ModTiers.ROSE_QUARTZ, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> SAPHIRE_SWORD = ITEMS.register("saphire_sword", () -> {
		return new SwordItem(ModTiers.SAPHIRE, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> SAPHIRE_PICKAXE = ITEMS.register("saphire_pickaxe", () -> {
		return new PickaxeItem(ModTiers.SAPHIRE, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> SAPHIRE_AXE = ITEMS.register("saphire_axe", () -> {
		return new AxeItem(ModTiers.SAPHIRE, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> SAPHIRE_SHOVEL = ITEMS.register("saphire_shovel", () -> {
		return new ShovelItem(ModTiers.SAPHIRE, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> SAPHIRE_HOE = ITEMS.register("saphire_hoe", () -> {
		return new HoeItem(ModTiers.SAPHIRE, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> STEEL_SWORD = ITEMS.register("steel_sword", () -> {
		return new SwordItem(ModTiers.STEEL, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> STEEL_PICKAXE = ITEMS.register("steel_pickaxe", () -> {
		return new PickaxeItem(ModTiers.STEEL, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> STEEL_AXE = ITEMS.register("steel_axe", () -> {
		return new AxeItem(ModTiers.STEEL, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> STEEL_SHOVEL = ITEMS.register("steel_shovel", () -> {
		return new ShovelItem(ModTiers.STEEL, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> STEEL_HOE = ITEMS.register("steel_hoe", () -> {
		return new HoeItem(ModTiers.STEEL, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> ENDERITE_SWORD = ITEMS.register("enderite_sword", () -> {
		return new SwordItem(ModTiers.ENDERITE, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> ENDERITE_PICKAXE = ITEMS.register("enderite_pickaxe", () -> {
		return new PickaxeItem(ModTiers.ENDERITE, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> ENDERITE_AXE = ITEMS.register("enderite_axe", () -> {
		return new AxeItem(ModTiers.ENDERITE, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> ENDERITE_SHOVEL = ITEMS.register("enderite_shovel", () -> {
		return new ShovelItem(ModTiers.ENDERITE, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> ENDERITE_HOE = ITEMS.register("enderite_hoe", () -> {
		return new HoeItem(ModTiers.ENDERITE, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<BowItem> ENDERITE_BOW = ITEMS.register("enderite_bow", () -> {
		return new BowItem(new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<CrossbowItem> ENDERITE_CROSSBOW = ITEMS.register("enderite_crossbow", () -> {
		return new CrossbowItem(new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShieldItem> ENDERITE_SHIELD = ITEMS.register("enderite_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/enderite_shield.png"));
	});
	...
	public static final RegistryObject<ArmorItem> ENDERITE_LEGGINGS = ITEMS.register("enderite_leggings", () -> {
		return new ArmorItem(ModArmorMaterials.ENDERITE, EquipmentSlot.HEAD, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<SwordItem> NIGHT_SWORD = ITEMS.register("night_sword", () -> {
		return new SwordItem(ModTiers.NIGHT, 0, -2.4F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<PickaxeItem> NIGHT_PICKAXE = ITEMS.register("night_pickaxe", () -> {
		return new PickaxeItem(ModTiers.NIGHT, 0, -2.8F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<AxeItem> NIGHT_AXE = ITEMS.register("night_axe", () -> {
		return new AxeItem(ModTiers.NIGHT, 0, -3.2F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<ShovelItem> ENIGHT_SHOVEL = ITEMS.register("night_shovel", () -> {
		return new ShovelItem(ModTiers.NIGHT, 0, -3.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	public static final RegistryObject<HoeItem> NIGHT_HOE = ITEMS.register("night_hoe", () -> {
		return new HoeItem(ModTiers.NIGHT, 0, 0.0F, new Item.Properties().tab(XOres.XORES_TAB));
	});
	...
	public static final RegistryObject<ShieldItem> NIGHT_SHIELD = ITEMS.register("night_shield", () -> {
		return new ModShieldItem(new Item.Properties().tab(XOres.XORES_TAB).defaultDurability(0), new ResourceLocation(XOres.MOD_ID, "textures/entity/night_shield.png"));
	});
