...
public class XOArmorMaterials {
	...
	public static final ArmorMaterial ENDERITE = new ArmorMaterial(51, ENDERITE_DEFENSE, 26, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 0.3F, XOItemTags.REPAIRS_ENDERITE_ARMOR, XOEquipmentModels.ENDERITE);
	public static final ArmorMaterial NIGHT = new ArmorMaterial(59, NIGHT_DEFENSE, 35, SoundEvents.ARMOR_EQUIP_NETHERITE, 8.0F, 0.4F, XOItemTags.REPAIRS_NIGHT_ARMOR, XOEquipmentModels.NIGHT);
	
	public static final ArmorMaterial DIAMOND_WINGS = new ArmorMaterial(33, DIAMOND_DEFENSE, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, ItemTags.REPAIRS_DIAMOND_ARMOR, XOEquipmentModels.DIAMOND_WINGS);
	public static final ArmorMaterial NETHERITE_WINGS = new ArmorMaterial(37, NETHERITE_DEFENSE, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, ItemTags.REPAIRS_NETHERITE_ARMOR, XOEquipmentModels.NETHERITE_WINGS);
