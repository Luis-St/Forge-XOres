...
public class XOItems {
	...
	public static final RegistryObject<ShieldItem> GOLDEN_SHIELD = ITEMS.register("golden_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).defaultDurability(180), new ResourceLocation(XOres.MOD_ID, "textures/entity/golden_shield.png"));
	});
	public static final RegistryObject<ShieldItem> COPPER_SHIELD = ITEMS.register("copper_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).defaultDurability(648), new ResourceLocation(XOres.MOD_ID, "textures/entity/copper_shield.png"));
	});
	public static final RegistryObject<ShieldItem> IRON_SHIELD = ITEMS.register("iron_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).defaultDurability(1298), new ResourceLocation(XOres.MOD_ID, "textures/entity/iron_shield.png"));
	});
	public static final RegistryObject<ShieldItem> DIAMOND_SHIELD = ITEMS.register("diamond_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).defaultDurability(2531), new ResourceLocation(XOres.MOD_ID, "textures/entity/diamond_shield.png"));
	});
	public static final RegistryObject<ShieldItem> NETHERITE_SHIELD = ITEMS.register("netherite_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).defaultDurability(11465), new ResourceLocation(XOres.MOD_ID, "textures/entity/netherite_shield.png"));
	});
	...
	public static final RegistryObject<ArmorItem> JADE_HELMET = ITEMS.register("jade_helmet", () -> {
		return new ArmorItem(XOArmorMaterials.JADE, EquipmentSlot.HEAD, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<ArmorItem> JADE_CHESTPLATE = ITEMS.register("jade_chestplate", () -> {
		return new ArmorItem(XOArmorMaterials.JADE, EquipmentSlot.CHEST, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<ArmorItem> JADE_LEGGINGS = ITEMS.register("jade_leggings", () -> {
		return new ArmorItem(XOArmorMaterials.JADE, EquipmentSlot.LEGS, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<ArmorItem> JADE_BOOTS = ITEMS.register("jade_boots", () -> {
		return new ArmorItem(XOArmorMaterials.JADE, EquipmentSlot.FEET, new Item.Properties().tab(XOres.TAB));
	});
	...
	public static final RegistryObject<BlazingArmorItem> BLAZING_HELMET = ITEMS.register("blazing_helmet", () -> {
		return new BlazingArmorItem(XOArmorMaterials.BLAZING, EquipmentSlot.HEAD, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<BlazingArmorItem> BLAZING_CHESTPLATE = ITEMS.register("blazing_chestplate", () -> {
		return new BlazingArmorItem(XOArmorMaterials.BLAZING, EquipmentSlot.CHEST, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<BlazingArmorItem> BLAZING_LEGGINGS = ITEMS.register("blazing_leggings", () -> {
		return new BlazingArmorItem(XOArmorMaterials.BLAZING, EquipmentSlot.LEGS, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<BlazingArmorItem> BLAZING_BOOTS = ITEMS.register("blazing_boots", () -> {
		return new BlazingArmorItem(XOArmorMaterials.BLAZING, EquipmentSlot.FEET, new Item.Properties().tab(XOres.TAB));
	});
	...
	public static final RegistryObject<ShieldItem> SAPHIRE_SHIELD = ITEMS.register("saphire_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(XOres.TAB).defaultDurability(5086), new ResourceLocation(XOres.MOD_ID, "textures/entity/saphire_shield.png"));
	});
	...
	public static final RegistryObject<SaphireArmorItem> SAPHIRE_HELMET = ITEMS.register("saphire_helmet", () -> {
		return new SaphireArmorItem(XOArmorMaterials.SAPHIRE, EquipmentSlot.HEAD, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<SaphireArmorItem> SAPHIRE_CHESTPLATE = ITEMS.register("saphire_chestplate", () -> {
		return new SaphireArmorItem(XOArmorMaterials.SAPHIRE, EquipmentSlot.CHEST, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<SaphireArmorItem> SAPHIRE_LEGGINGS = ITEMS.register("saphire_leggings", () -> {
		return new SaphireArmorItem(XOArmorMaterials.SAPHIRE, EquipmentSlot.LEGS, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<SaphireArmorItem> SAPHIRE_BOOTS = ITEMS.register("saphire_boots", () -> {
		return new SaphireArmorItem(XOArmorMaterials.SAPHIRE, EquipmentSlot.FEET, new Item.Properties().tab(XOres.TAB));
	});
	...
	public static final RegistryObject<LimoniteArmorItem> LIMONITE_HELMET = ITEMS.register("limonite_helmet", () -> {
		return new LimoniteArmorItem(XOArmorMaterials.LIMONITE, EquipmentSlot.HEAD, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<LimoniteArmorItem> LIMONITE_CHESTPLATE = ITEMS.register("limonite_chestplate", () -> {
		return new LimoniteArmorItem(XOArmorMaterials.LIMONITE, EquipmentSlot.CHEST, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<LimoniteArmorItem> LIMONITE_LEGGINGS = ITEMS.register("limonite_leggings", () -> {
		return new LimoniteArmorItem(XOArmorMaterials.LIMONITE, EquipmentSlot.LEGS, new Item.Properties().tab(XOres.TAB));
	});
	...
	public static final RegistryObject<ShieldItem> ENDERITE_SHIELD = ITEMS.register("enderite_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(XOres.TAB).defaultDurability(22812), new ResourceLocation(XOres.MOD_ID, "textures/entity/enderite_shield.png"));
	});
	...
	public static final RegistryObject<EnderiteHelmetItem> ENDERITE_HELMET = ITEMS.register("enderite_helmet", () -> {
		return new EnderiteHelmetItem(XOArmorMaterials.ENDERITE, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<EnderiteArmorItem> ENDERITE_CHESTPLATE = ITEMS.register("enderite_chestplate", () -> {
		return new EnderiteArmorItem(XOArmorMaterials.ENDERITE, EquipmentSlot.CHEST, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<EnderiteElytraChestplateItem> ENDERITE_ELYTRA_CHESTPLATE = ITEMS.register("enderite_elytra_chestplate", () -> {
		return new EnderiteElytraChestplateItem(XOArmorMaterials.ENDERITE, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<EnderiteArmorItem> ENDERITE_LEGGINGS = ITEMS.register("enderite_leggings", () -> {
		return new EnderiteArmorItem(XOArmorMaterials.ENDERITE, EquipmentSlot.LEGS, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<EnderiteArmorItem> ENDERITE_BOOTS = ITEMS.register("enderite_boots", () -> {
		return new EnderiteArmorItem(XOArmorMaterials.ENDERITE, EquipmentSlot.FEET, new Item.Properties().tab(XOres.TAB));
	});
	...
	public static final RegistryObject<ShieldItem> NIGHT_SHIELD = ITEMS.register("night_shield", () -> {
		return new XOShieldItem(new Item.Properties().tab(XOres.TAB).defaultDurability(38978), new ResourceLocation(XOres.MOD_ID, "textures/entity/night_shield.png"));
	});
	...
	public static final RegistryObject<NightArmorItem> NIGHT_HELMET = ITEMS.register("night_helmet", () -> {
		return new NightArmorItem(XOArmorMaterials.NIGHT, EquipmentSlot.HEAD, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<NightArmorItem> NIGHT_CHESTPLATE = ITEMS.register("night_chestplate", () -> {
		return new NightArmorItem(XOArmorMaterials.NIGHT, EquipmentSlot.CHEST, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<NightElytraChestplateItem> NIGHT_ELYTRA_CHESTPLATE = ITEMS.register("night_elytra_chestplate", () -> {
		return new NightElytraChestplateItem(XOArmorMaterials.NIGHT, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<NightArmorItem> NIGHT_LEGGINGS = ITEMS.register("night_leggings", () -> {
		return new NightArmorItem(XOArmorMaterials.NIGHT, EquipmentSlot.LEGS, new Item.Properties().tab(XOres.TAB));
	});
	public static final RegistryObject<NightArmorItem> NIGHT_BOOTS = ITEMS.register("night_boots", () -> {
		return new NightArmorItem(XOArmorMaterials.NIGHT, EquipmentSlot.FEET, new Item.Properties().tab(XOres.TAB));
	});
