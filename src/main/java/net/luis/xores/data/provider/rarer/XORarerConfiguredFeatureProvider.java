...
package net.luis.xores.data.provider.rarer;
...
import static net.luis.xores.data.provider.base.server.XOConfiguredFeatureProvider.*;
...
public class XORarerConfiguredFeatureProvider {
	...
	private static void createVanilla(@NotNull BootstrapContext<ConfiguredFeature<?, ?>> context) {
	...
	private static void createXOres(@NotNull BootstrapContext<ConfiguredFeature<?, ?>> context) {
