	...
	private void shieldItem(ShieldItem shield) {
		...
		this.getBuilder(location.getPath()).parent(model).guiLight(GuiLight.FRONT).texture("particle", new ResourceLocation("block/dark_oak_planks"))
			.transforms()
				...
				.transform(TransformType.FIXED).rotation(0.0F, 180.0F, 0.0F).translation(-4.5F, 4.5F, -5.0F).scale(0.55F).end()
				.transform(TransformType.GROUND).rotation(0.0F, 0.0F, 0.0F).translation(2.0F, 4.0F, 2.0F).scale(0.25F).end()
			.end().override()
		...
		this.getBuilder(location.getPath() + "_blocking").parent(model).guiLight(GuiLight.FRONT).texture("particle", new ResourceLocation("block/dark_oak_planks"))
			.transforms()
				...
				.transform(TransformType.THIRD_PERSON_LEFT_HAND).rotation(45.0F, 135.0F, 0.0F).translation(13.51F, 3.0F, 5.0F).scale(1.0F).end()
