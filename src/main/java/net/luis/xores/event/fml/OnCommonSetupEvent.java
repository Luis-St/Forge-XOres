...
public class OnCommonSetupEvent {
	...
	public static void commonSetup(FMLCommonSetupEvent event) {
		Util.make(ElytraChestplateItem.ELYTRA_TIME_DAMAGE_VALUES, map -> {
			map.put(XOresItems.DIAMOND_ELYTRA_CHESTPLATE.get(), 40);
			map.put(XOresItems.NETHERITE_ELYTRA_CHESTPLATE.get(), 60);
			map.put(XOresItems.ENDERITE_ELYTRA_CHESTPLATE.get(), 80);
			map.put(XOresItems.NIGHT_ELYTRA_CHESTPLATE.get(), 100);
		});
		event.enqueueWork(() -> {
