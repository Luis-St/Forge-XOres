...
public enum ModTiers implements Tier {
	...
	JADE("jade", 190, 5.0F, 5.0F, 2, ModTags.Blocks.MINING_LEVEL_2, 28, () -> {
		return Ingredient.of(ModItems.JADE_INGOT.get());
	}),
	BLAZING("blazing", 905, 7.0F, 6.0F, 2, ModTags.Blocks.MINING_LEVEL_2, 12, () -> {
		return Ingredient.of(ModItems.BLAZING_INGOT.get());
	}),
	SAPHIRE("saphire", 1718, 8.0F, 8.0F, 3, ModTags.Blocks.MINING_LEVEL_3, 42, () -> {
		return Ingredient.of(ModItems.SAPHIRE_INGOT.get());
	}),
	LIMONITE("limonite", 3178, 10.0F, 10.0F, 5, ModTags.Blocks.MINING_LEVEL_5, 26, () -> {
		return Ingredient.of(ModItems.LIMONITE_INGOT.get());
	}),
	ROSITE("rosite", 4916, 10.0F, 11.0F, 4, ModTags.Blocks.MINING_LEVEL_4, 12, () -> {
		return Ingredient.of(ModItems.ROSITE_INGOT.get());
	}),
	ROSE_QUARTZ("rose_quartz", 7693, 11.0F, 12.0F, 4, ModTags.Blocks.MINING_LEVEL_4, 17, () -> {
		return Ingredient.of(ModItems.ROSE_QUARTZ.get());
	}),
	ENDERITE("enderite", 10770, 14.0F, 16.0F, 5, ModTags.Blocks.MINING_LEVEL_5, 18, () -> {
		return Ingredient.of(Items.BARRIER);
	}),
	STEEL("steel", 12924, 18.0F, 5.0F, 6, ModTags.Blocks.MINING_LEVEL_6, 9, () -> {
		return Ingredient.of(ModItems.STEEL_INGOT.get());
	}),
	NIGHT("night", 16801, 15.0F, 19.0F, 5, ModTags.Blocks.MINING_LEVEL_5, 56, () -> {
		return Ingredient.of(Items.BARRIER);
	});
