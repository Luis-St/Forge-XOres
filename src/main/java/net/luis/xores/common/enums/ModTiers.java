...
public enum ModTiers implements Tier {
	...
	JADE("jade", 190, 5.0F, 5.0F, 2, BlockTags.NEEDS_IRON_TOOL, 28, () -> {
		return Ingredient.of(ModItems.JADE_INGOT.get());
	}),
	BLAZING("blazing", 905, 7.0F, 6.0F, 2, BlockTags.NEEDS_IRON_TOOL, 12, () -> {
		return Ingredient.of(ModItems.BLAZING_INGOT.get());
	}),
	SAPHIRE("saphire", 1718, 8.0F, 8.0F, 3, BlockTags.NEEDS_DIAMOND_TOOL, 42, () -> {
		return Ingredient.of(ModItems.SAPHIRE_INGOT.get());
	}),
	LIMONITE("limonite", 3178, 10.0F, 10.0F, 5, ModTags.Blocks.NEEDS_ENDERITE_TOOL, 26, () -> {
		return Ingredient.of(ModItems.LIMONITE_INGOT.get());
	}),
	ROSITE("rosite", 4916, 10.0F, 11.0F, 4, ModTags.Blocks.NEEDS_NETHERITE_TOOL, 12, () -> {
		return Ingredient.of(ModItems.ROSITE_INGOT.get());
	}),
	ROSE_QUARTZ("rose_quartz", 7693, 11.0F, 12.0F, 4, ModTags.Blocks.NEEDS_NETHERITE_TOOL, 17, () -> {
		return Ingredient.of(ModItems.ROSE_QUARTZ.get());
	}),
	ENDERITE("enderite", 10770, 14.0F, 16.0F, 5, ModTags.Blocks.NEEDS_ENDERITE_TOOL, 18, () -> {
		return Ingredient.of(Items.BARRIER);
	}),
	STEEL("steel", 12924, 18.0F, 5.0F, 6, ModTags.Blocks.NEEDS_STEEL_TOOL, 9, () -> {
		return Ingredient.of(ModItems.STEEL_INGOT.get());
	}),
	NIGHT("night", 16801, 15.0F, 19.0F, 5, ModTags.Blocks.NEEDS_ENDERITE_TOOL, 56, () -> {
		return Ingredient.of(Items.BARRIER);
	});
