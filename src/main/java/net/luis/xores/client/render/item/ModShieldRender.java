...
public class ModShieldRender extends BlockEntityWithoutLevelRenderer {
	...
	public ModShieldRender(BlockEntityRenderDispatcher renderDispatcher, EntityModelSet modelSet, ResourceLocation location) {
	...
	public void renderByItem(ItemStack stack, TransformType transformType, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay) {
        ...
        VertexConsumer vertexconsumer = ItemRenderer.getFoilBufferDirect(bufferSource, this.shieldModel.renderType(this.location), true, stack.hasFoil());
